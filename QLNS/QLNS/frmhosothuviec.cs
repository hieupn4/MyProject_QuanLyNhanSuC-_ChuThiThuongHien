...
namespace QLNS
{
    public partial class frmhosothuviec : Form
    {
        ...
        {
            Cry_thuviec tv = new Cry_thuviec();
            tv.ShowDialog();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            //try
           // {
                string update = "update TblHoSoThuViec set MaPhong=N'" + comboBox1.Text + "',HoTen=N'" + txt2.Text + "',NgaySinh=N'" + dateTimePicker1.Text + "',GioiTinh=N'" + txt4.Text + "',DiaChi=N'" + txt5.Text + "',TDHocVan=N'" + txt6.Text + "',HocHam=N'" + txt7.Text + "',VTriThuViec=N'" + txt8.Text + "',NgayTV=N'" + dateTimePicker2.Text + "',SoThangTV=N'" + txt10.Text + "',GhiChu=N'" + txt11.Text + "' where MaNV='" + txt1.Text + "'";
