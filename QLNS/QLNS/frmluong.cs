    ...
    public partial class frmluong : Form
    {
        ...
        private void frmluong_Load(object sender, EventArgs e)
        {
           ...
           /* cls.loaddatagridview(dataGridView1, "select * from TblBangLuongCTy");
            ...
            cls.loaddatagridview(dataGridView3, "select * from TblBangLuong");
        }
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            cls.loadtextbox(txt13, "select ChucDanh from TblTTNVCoBan where MaNV='" + comboBox1.Text + "'");
            cls.loadtextbox(txt14, "select LCB from TblBangLuong where MaNV='" + comboBox1.Text + "'");

            cls.loadtextbox(txt16, "select PCChucVu from TblBangLuong where MaNV='" + comboBox1.Text + "'");
        ...
        private void button11_Click_1(object sender, EventArgs e)
        {
            try
            {
                ...
                string insert = "insert into TblTangLuong values(N'" + comboBox1.Text + "',N'" + txt10.Text + "',N'" + txt11.Text + "',N'" + txt12.Text + "',N'" + txt13.Text + "',N'" + txt14.Text + "',N'" + txt15.Text + "',N'" + txt16.Text + "',N'" + txt17.Text + "',N'" + dateTimePicker6.Text + "',N'" + txt18.Text + "')";
                string update = "update TblBangLuong set LCB=N'" + txt15.Text + "',PCChucVu=N'" + txt17.Text + "' where MaNV='" + comboBox1.Text+"'";
        ...
        {
            frm_cry_tangluong xpss = new frm_cry_tangluong();
            xpss.Show();
        }
    }
}
