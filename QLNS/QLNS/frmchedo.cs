...
namespace QLNS
{
    public partial class frmchedo : Form
    {
        ...
        private void button12_Click(object sender, EventArgs e)
        {
            try
            {
                string update = "update TblThaiSan set HoTen=N'" + txt7.Text + "',NgaySinh=N' ',NgayVeSom=' ',NgayNghiSinh=N' ',NgayLamTroLai='" + dt5.Text + "',TroCapCTy=N'" + txt8.Text + "',GhiChu=N'" + txt9.Text + "' where MaNV=N'" + comboBox2.Text + "'";
        ...
        {
            frm_Cry_baohiem fbh = new frm_Cry_baohiem();
            fbh.ShowDialog();
        }
        ...
        private void button11_Click(object sender, EventArgs e)
        {
          //try
           // {
            string insert = "insert into TblThaiSan values(N'" + txt5.Text + "',N'" + txt6.Text + "',N'" + comboBox2.Text + "',N'" + txt7.Text + "',N'" + dt4.Text + "',N'" + dt4.Text + "',N'" + dt4.Text + "',N'" + dt5.Text + "',N'" + txt8.Text + "',N'" + txt9.Text + "')";
            //string insert = "insert into TblThaiSan values('" + comboBox1.Text + "',N'" + textBox2.Text + "',N'" + textBox3.Text + "',N'" + dateTimePicker1.Text + "',N'" + textBox5.Text + "')";
            //string insert = "insert into TblThaiSan Values(HoTen='" + txt7.Text + "',NgaySinh='5/15/2015',NgayVeSom='5/15/2015',NgayNghiSinh='5/15/2015',NgayLamTroLai='5/15/2015',TroCapCTy='" + txt8.Text + "',GhiChu='" + txt9.Text + "' where MaNV='" + comboBox2.Text + "')";
                cls.thucthiketnoi(insert);
                cls.loaddatagridview1(dataGridView2, ds2, "select * from TblThaiSan");
           // }
           /* catch
        ...
        {
            frm_Cry_thaisan fmts = new frm_Cry_thaisan();
            fmts.ShowDialog();
        }
    }
}
